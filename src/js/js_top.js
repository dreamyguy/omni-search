...
(function(B, f, w) {
    "use strict";
    f.module("ngResource", [ "ng" ]).factory("$resource", [ "$http", "$parse", function(x, y) {
        function u(b, d) {
            this.template = b;
            this.defaults = d || {};
            this.urlParams = {};
        ...
        function v(b, d, e) {
            function j(c, b) {
                ...
                l(b, function(a, b) {
                    k(a) && (a = a());
                    var g;
                    a && a.charAt && a.charAt(0) == "@" ? (g = a.substr(1), g = y(g)(c)) : g = a;
                    p[b] = g;
                });
                return p;
            }
            ...
            var n = new u(b), e = m({}, z, e);
            l(e, function(b, d) {
                b.method = f.uppercase(b.method);
                var p = b.method == "POST" || b.method == "PUT" || b.method == "PATCH";
                c[d] = function(a, d, g, A) {
                    function f() {
                        h.$resolved = !0;
                    }
                    var i = {}, e, o = q, r = null;
                    ...
                    var h = this instanceof c ? this : b.isArray ? [] : new c(e), s = {};
                    l(b, function(a, b) {
                        b != "params" && b != "isArray" && (s[b] = t(a));
                    });
                    s.data = e;
                    n.setUrlParams(s, m({}, j(e, b.params || {}), i), b.url);
                    i = x(s);
                    h.$resolved = !1;
                    i.then(f, f);
                    h.$then = i.then(function(a) {
                        var d = a.data, g = h.$then, e = h.$resolved;
                        if (d) b.isArray ? (h.length = 0, l(d, function(a) {
                            h.push(new c(a));
                        })) : (t(d, h), h.$then = g, h.$resolved = e);
                        (o || q)(h, a.headers);
                        a.resource = h;
                        return a;
                    }, r).then;
        ...
        }, q = f.noop, l = f.forEach, m = f.extend, t = f.copy, k = f.isFunction;
        u.prototype = {
            setUrlParams: function(b, d, e) {
                var j = this, c = e || j.template, n, k, m = j.urlParams = {};
                l(c.split(/\W/), function(b) {
                    b && RegExp("(^|[^\\\\]):" + b + "(\\W|$)").test(c) && (m[b] = !0);
                });
                c = c.replace(/\\:/g, ":");
                d = d || {};
                l(j.urlParams, function(b, a) {
                    n = d.hasOwnProperty(a) ? d[a] : j.defaults[a];
                    f.isDefined(n) && n !== null ? (k = encodeURIComponent(n).replace(/%40/gi, "@").replace(/%3A/gi, ":").replace(/%24/g, "$").replace(/%2C/gi, ",").replace(/%20/g, "%20").replace(/%26/gi, "&").replace(/%3D/gi, "=").replace(/%2B/gi, "+"), 
                    c = c.replace(RegExp(":" + a + "(\\W|$)", "g"), k + "$1")) : c = c.replace(RegExp("(/?):" + a + "(\\W|$)", "g"), function(b, a, c) {
                ...
                b.url = c.replace(/\/\\\./, "/.");
                l(d, function(c, a) {
                    if (!j.urlParams[a]) b.params = b.params || {}, b.params[a] = c;
                });
            }
        };
        return v;
...
var epoch = d.getTime() / 1e3;

WebFontConfig = {
    custom: {
        families: [ "DobraMedium", "DobraSlabMedium", "DobraBook" ],
        urls: [ "src/css/fonts.css?epoch=" + Math.floor(epoch) ]
    }
};
